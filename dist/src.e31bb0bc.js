...
var API_ADRESS = 'https://spotify-api-wrapper.appspot.com';
...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      fetch("".concat(API_ADRESS, "/artist/").concat(artistQuery)).then(function (response) {
        ...
        if (json.artists.total > 0) {
          ...
          fetch("".concat(API_ADRESS, "/artist/").concat(artist.id, "/top-tracks")).then(function (response) {
            return response.json();
          }).then(function (json) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h2", null, "Melek's Music Box"), /*#__PURE__*/_react.default.createElement(_search.default, {
